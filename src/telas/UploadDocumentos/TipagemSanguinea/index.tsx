...
const TipagemSanguinea: React.FC = () => {
    ...
    fetch('http://192.168.0.103:3333/cidadao/submetertipagemsanguinea', {
      method: 'PATCH',
	...
	return (
		<Container>
			...
			{bcode ? <Text>{bcode} - Tipagem sanguínea</Text> : <Text></Text>}
...
export default TipagemSanguinea;
